...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater != null ? infalInflater.inflate(R.layout.list_item, null) : null;
        }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        TextView lblListHeader = (TextView) (convertView != null ? convertView
                .findViewById(R.id.lblListHeader) : null);
